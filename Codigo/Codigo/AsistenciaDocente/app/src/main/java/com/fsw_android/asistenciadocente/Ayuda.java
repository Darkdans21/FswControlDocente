...
public class Ayuda extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent i = new Intent(Ayuda.this, Recorrido.class);
            startActivity(i);
        }
        ...
        {
            Intent i = new Intent(Ayuda.this, NuevoReporte.class);
            startActivity(i);
        }
        else if (id == R.id.nav_ayuda)
        {
            Intent i = new Intent(Ayuda.this, Ayuda.class);
            startActivity(i);
        }
        else if (id == R.id.nav_cerrrar_sesion)
        {
            Intent i = new Intent(Ayuda.this, CerrandoSesion.class);
            startActivity(i);
        }
