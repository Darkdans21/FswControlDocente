...
public class EscaneoSanitario extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_escaneo_sanitario);
        ...
        btn_barras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(EscaneoSanitario.this , RegistroSanitario.class);
                startActivity(i);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.escaneo_sanitario, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent i = new Intent(EscaneoSanitario.this, Recorrido.class);
            startActivity(i);
        }
        ...
        {
            Intent i = new Intent(EscaneoSanitario.this, NuevoReporte.class);
            startActivity(i);
        }
        else if (id == R.id.nav_ayuda)
        {
            Intent i = new Intent(EscaneoSanitario.this, Ayuda.class);
            startActivity(i);
        }
        else if (id == R.id.nav_cerrrar_sesion)
        {
            Intent i = new Intent(EscaneoSanitario.this, CerrandoSesion.class);
            startActivity(i);
        }
