...
public class NuevoReporte extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_nuevo_incorrecto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intento_validacion = new Intent(NuevoReporte.this, RegistroProfesorIncorrecto.class);
        ...
        btn_nuevo_correcto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intento_validacion = new Intent(NuevoReporte.this, RegistroProfesorCorrecto.class);
                startActivity(intento_validacion);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.nuevo_reporte, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent i = new Intent(NuevoReporte.this, Recorrido.class);
            startActivity(i);
        }
        ...
        {
            Intent i = new Intent(NuevoReporte.this, NuevoReporte.class);
            startActivity(i);
        }
        else if (id == R.id.nav_ayuda)
        {
            Intent i = new Intent(NuevoReporte.this, Ayuda.class);
            startActivity(i);
        }
        else if (id == R.id.nav_cerrrar_sesion)
        {
            Intent i = new Intent(NuevoReporte.this, CerrandoSesion.class);
            startActivity(i);
        }
